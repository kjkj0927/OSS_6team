...
### 🏡 가게 분위기
가게 안에 혼밥할 수 있는 다찌석 4~5자리, 2인석 테이블 2개, 4인석 테이블 하나 정도로 협소한 편.

### 🍽 음식 평가

홍국쌀이 들어간 빨간 튀김옷 돈카츠로 유명한 식당이다. 겉은 바삭하고 속은 촉촉한 식감이 특징이며 흑돼지를 사용해 육즙이 풍부하다.  

누룩 소금 숙성으로 육질이 부드럽고 풍미가 깊다. 또한 사사미 카츠나 블랙 타이거 새우 등심카츠 같은 특별한 메뉴도 있어 다양한 돈카츠를 즐길 수 있다. 밥이 무한리필이라 학생들에게 만족도가 높은 식당이다. 다만, 가게가 좁아서 늦게 가면 무조건 웨이팅 당첨이니 점심시간 일찍 가는 것을 추천한다.
...
### 🏡 가게 분위기 
4인석 테이블 7개 정도로 단체로 가기 좋다.

### 🍽 음식 평가

안동찜닭 특유의 짭짤하고 달콤한 간장 양념이 특징이다. 적당한 마늘 향이 어우러져 깊은 풍미를 느낄 수 있으며 당면과 함께 먹으면 더욱 맛있다.  
...
### 🏡 가게 분위기
최근에 리모델링을 해서 테이블 개수를 줄여서 상대적으로 가게 내부가 넓어지고 깔끔해졌다. 2인 테이블 6개에 4인 테이블 2~3개 정도로 아담하지만 적당한 크기의 가게이다.
...
### 🏡 가게 분위기 
4인 테이블 8개 정도로 단체로 가도 손색 없고 혼밥 하는 사람도 많아서 점심에 가기 딱 좋은 곳이다.
...
### 🏡 가게 분위기 
테이블 간 간격이 넓고 4인 테이블이 10~12개 정도이고 가게 내부가 넓다. 그리고 화장실이 내부에 있어서 편하다.
